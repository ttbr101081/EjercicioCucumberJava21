...
public class DOM {
    ...
    public static WebDriver webDriver() {
        if (driver == null) {
            String chromeDriverPath = "C:\\Users\\RODRIGO\\OneDrive - berrymuch\\entrevista de trabajo ntt\\procesosSeleccion\\PE2E\\src\\test\\resources\\webdriver\\chromedriver.exe";
